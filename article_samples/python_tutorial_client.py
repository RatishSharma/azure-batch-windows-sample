...
# mooncake
_BATCH_ACCOUNT_NAME = '<batch name>'
_BATCH_ACCOUNT_KEY = '<batch key>'
_BATCH_ACCOUNT_URL = '<batch url>'

_STORAGE_ACCOUNT_NAME = '<storage name>'
_STORAGE_ACCOUNT_KEY = '<storage key>'

_JOB_ID = 'PythonTutorialJob01'
_POOL_ID = 'PythonTutorialPool01'
_POOL_NODE_COUNT = 1
_POOL_VM_SIZE = 'Small'
